...
function mdtf_SolicitarBaremos($genero, $oposiciones, $edad){
	...
	if($oposiciones=="Policía Nacional"){
		...
		$mfPuntHPolNac= array( array(11.7,11.5,11.3,11,10.6,10.2,9.8,9.4,8.9,8.3,8.2), array(4,5,6,7,9,11,13,14,15,16,17), array(3.49,3.43,3.37,3.31,3.25,3.19,3.13,3.07,3.01,2.55,2.54));
		
		$mfPuntMPolNac= array( array(12.8,12.6,12.4,12.1,11.7,11.3,10.9,10.4,9.9,9.4,9.3), array(35,40,45,51,56,62,69,77,85,94,95), array(4.46,4.37,4.28,4.19,4.1,4.01,3.52,3.43,3.34,3.25,3.24));
	...
	elseif($oposiciones=="Policía Local"){
		//Constantes
		$mfPuntH18a24PolLoc= array(8,8,26,48,4,26);
		$mfPuntH25a29PolLoc= array(8.5,6,23,44,4.1,29);
		$mfPuntH30a34PolLoc= array(9,4,20,40,4.2,32);
		$mfPuntM18a24PolLoc= array(9,5.5,26,35,4.3,30);
		$mfPuntM25a29PolLoc= array(9.5,5.25,23,33,4.4,33);
		$mfPuntM30a34PolLoc= array(10,5,20,31,4.5,36);
	...
	elseif ($oposiciones=="Seguridad Privada"){
		...
		//Constantes
		$mfPuntH18a25SegPriv= array(4,44,1.12);
		$mfPuntH26a32SegPriv= array(3,42,1.14);
		$mfPuntH33a39SegPriv= array(2,40,1.20);
		$mfPuntH40a50SegPriv= array(7,36,1.30);
		$mfPuntHMAS51SegPriv= array(6.5,34,1.45);
		$mfPuntM18a25SegPriv= array(4.75,36,1.33);
		$mfPuntM26a32SegPriv= array(4.25,34,1.40);
		$mfPuntM33a39SegPriv= array(4,32,1.49);
		$mfPuntM40a50SegPriv= array(3.75,28,1.56);
		$mfPuntMMAS51SegPriv= array(3.5,25,2.06);
	...
	elseif($oposiciones=="Ejercito"){
		...
		$mfPuntHNivAEjerc= array(145,15,5,5);
		$mfPuntHNivBEjerc= array(163,21,8,5.5);
		$mfPuntHNivCEjerc= array(187,27,10,6.5);
		$mfPuntHNivDEjerc= array(205,33,13,7.5);
		$mfPuntMNivAEjerc= array(121,10,3,3.5);
		$mfPuntMNivBEjerc= array(136,14,5,4);
		$mfPuntMNivCEjerc= array(156,18,6,5);
		$mfPuntMNivDEjerc= array(171,22,8,7);
	...
	elseif($oposiciones=="Guardia Civil"){
		$mfPuntHMEN35GuarCiv= array(10,9.25,16,70);
		$mfPuntH35a39GuarCiv= array(10.30,9.48,16,71);
		$mfPuntHMAS40GuarCiv= array(10.80,10.33,14,73);
		$mfPuntMMEN35GuarCiv= array(11.20,11.14,11,81);
		$mfPuntM35a39GuarCiv= array(11.50,11.35,11,83);
		$mfPuntMMAS40GuarCiv= array(12.50,12.49,9,88);
